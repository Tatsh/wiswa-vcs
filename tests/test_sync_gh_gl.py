...
def test_sync_gh_gl_decodes_gitlab_config_from_file(runner: CliRunner, mocker: MockerFixture,
                                                    tmp_path: Path) -> None:
...
def test_sync_gh_gl_rejects_gitlab_config_file_with_invalid_json(runner: CliRunner,
